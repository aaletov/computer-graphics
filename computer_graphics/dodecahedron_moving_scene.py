...
class DodecahedronMovingScene(WindowBase):
    title = 'Hello Program'
    ...
    def __init__(self, **kwargs):
        ...
        self.models: List[MovingModel] = [
            MovingModel(self.ctx, self.prog, ddh, [1] + [10, 7, 0, 4, 8] * 8),
        ]
...
class MovingModel:
    ...
    def render(self) -> None:
        self.vbo.clear()
        if self.roll_angle >= (math.acos(-1 / math.sqrt(5)) - math.pi / 3):
            self.roll_idx += 1
            self.roll_angle = 0
