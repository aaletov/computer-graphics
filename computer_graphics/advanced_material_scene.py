...
from .material import Material, RED_PLASTIC, SHINY_GOLD, DIM_PEARL, DIM_PEARL_GLASS, DIM_SILVER, SILVER

class AdvancedMaterialScene(WindowBase):
    title = 'Hello Program'
