...
from .solid import Solid, createDodecahedron, createCube, createTetrahedron, createCone

class Lab2Scene(WindowBase):
    title = 'Hello Program'
    ...
    def __init__(self, **kwargs):
        ...
        self.models: List[BaseModel] = [
            ...
            DumbModel(self.ctx, self.prog, createCone(), tt_vertex_tex)
        ]
